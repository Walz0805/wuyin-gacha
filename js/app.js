...
function playCutsceneStage(options, shouldStop){
  return new Promise(resolve=>{
    ...
    const fallbackImg=options.image ? `<img class="cutscene-card-img" src="${options.image}" onerror="this.style.display='none'">` : '';
    panel.innerHTML=`
