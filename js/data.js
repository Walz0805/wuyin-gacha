...
const CARDS = [
  ...
  { id:'shang_yunluo', tone:'shang', name:'商调 · 云锣', instrument:'云锣', rarity:'SSR', rarityName:'天籁', role:'云中金响', description:'云锣由多面小锣组合而成，音色明亮轻巧，层层敲响时如云间金声流转。', image:'assets/cards/shang_yunluo.png', mobileImage:'assets/cards/shang_yunluo.png', toneName:'商音', element:'金', fullAudio:'assets/audio/shang_yunluo.mp3', pieceAudio:'assets/audio/shang_yunluo.mp3', audioSegmentSeconds:10 },
  { id:'jiao_guanzi', tone:'jiao', name:'角调 · 管子', instrument:'管子', rarity:'SSR', rarityName:'天籁', role:'北地长风', description:'管子音色高亢而有穿透力，气息充足时带有苍劲、开阔的民间风味。', image:'assets/cards/jiao_guanzi.png', mobileImage:'assets/cards/jiao_guanzi.png', toneName:'角音', element:'木', fullAudio:'assets/audio/jiao_guanzi.m4a', pieceAudio:'assets/audio/jiao_guanzi.m4a', audioSegmentSeconds:10 },
  ...
  { id:'jiao_qudi', tone:'jiao', name:'角调 · 曲笛', instrument:'曲笛', rarity:'SSR', rarityName:'天籁', role:'江南清韵', description:'曲笛音色圆润婉转，常用于江南丝竹，旋律轻巧流丽，带有水乡气息。', image:'assets/cards/jiao_qudi.png', mobileImage:'assets/cards/jiao_qudi.png', toneName:'角音', element:'木', fullAudio:'assets/audio/jiao_qudi.mp3', pieceAudio:'assets/audio/jiao_qudi.mp3', audioSegmentSeconds:10 },
  { id:'jiao_xiao', tone:'jiao', name:'角调 · 箫', instrument:'箫', rarity:'SSR', rarityName:'天籁', role:'孤竹月影', description:'箫声幽远含蓄，长音如月下清风，适合表现静夜、山水与悠长思绪。', image:'assets/cards/jiao_xiao.png', mobileImage:'assets/cards/jiao_xiao.png', toneName:'角音', element:'木', fullAudio:'assets/audio/jiao_xiao.mp3', pieceAudio:'assets/audio/jiao_xiao.mp3', audioSegmentSeconds:10 },
  ...
  { id:'zhi_gaohu', tone:'zhi', name:'徵调 · 高胡', instrument:'高胡', rarity:'SSR', rarityName:'天籁', role:'岭南流霞', description:'高胡音色清亮柔美，旋律华丽灵动，常带有岭南音乐明快细腻的色彩。', image:'assets/cards/zhi_gaohu.png', mobileImage:'assets/cards/zhi_gaohu.png', toneName:'徵音', element:'火', fullAudio:'assets/audio/zhi_gaohu.mp3', pieceAudio:'assets/audio/zhi_gaohu.mp3', audioSegmentSeconds:10 },
  { id:'zhi_guqin', tone:'zhi', name:'徵调 · 古琴', instrument:'古琴', rarity:'SSR', rarityName:'天籁', role:'松风入弦', description:'古琴音色沉静、古雅而留白，泛音、按音与散音交织出山林般的悠远气息。', image:'assets/cards/zhi_guqin.png', mobileImage:'assets/cards/zhi_guqin.png', toneName:'徵音', element:'火', fullAudio:'assets/audio/zhi_guqin.m4a', pieceAudio:'assets/audio/zhi_guqin.m4a', audioSegmentSeconds:10 },
  { id:'zhi_guzheng', tone:'zhi', name:'徵调 · 古筝', instrument:'古筝', rarity:'SSR', rarityName:'天籁', role:'弦河流火', description:'古筝音域宽广，颗粒清晰，既能铺陈流水般的华彩，也能奏出强烈的情绪起伏。', image:'assets/cards/zhi_guzheng.png', mobileImage:'assets/cards/zhi_guzheng.png', toneName:'徵音', element:'火', fullAudio:'assets/audio/zhi_guzheng.mp3', pieceAudio:'assets/audio/zhi_guzheng.mp3', audioSegmentSeconds:10 },
  { id:'zhi_jinghu', tone:'zhi', name:'徵调 · 京胡', instrument:'京胡', rarity:'SSR', rarityName:'天籁', role:'梨园烈响', description:'京胡音色高亮尖细，穿透力极强，是戏曲音乐中最具辨识度的弓弦声之一。', image:'assets/cards/zhi_jinghu.png', mobileImage:'assets/cards/zhi_jinghu.png', toneName:'徵音', element:'火', fullAudio:'assets/audio/zhi_jinghu.mp3', pieceAudio:'assets/audio/zhi_jinghu.mp3', audioSegmentSeconds:10 },
  { id:'zhi_matouqin', tone:'zhi', name:'徵调 · 马头琴', instrument:'马头琴', rarity:'SSR', rarityName:'天籁', role:'草原长歌', description:'马头琴音色浑厚悠长，常让人联想到辽阔草原、远方风声与低回长歌。', image:'assets/cards/zhi_matouqin.png', mobileImage:'assets/cards/zhi_matouqin.png', toneName:'徵音', element:'火', fullAudio:'assets/audio/zhi_matouqin.mp3', pieceAudio:'assets/audio/zhi_matouqin.mp3', audioSegmentSeconds:10 },
  { id:'zhi_pipa', tone:'zhi', name:'徵调 · 琵琶', instrument:'琵琶', rarity:'SSR', rarityName:'天籁', role:'银甲急雨', description:'琵琶弹拨清脆多变，轮指、扫弦与挑弹之间既有珠落玉盘，也有战阵急雨。', image:'assets/cards/zhi_pipa.png', mobileImage:'assets/cards/zhi_pipa.png', toneName:'徵音', element:'火', model:'assets/models/zhi_pipa.glb', modelFallbacks:['assets/models/pipa.glb','assets/models/scene.glb'], modelAlt:'徵调琵琶三维模型', fullAudio:'assets/audio/zhi_pipa.m4a', pieceAudio:'assets/audio/zhi_pipa.m4a', audioSegmentSeconds:10 },
  ...
  { id:'zhi_zhongruan', tone:'zhi', name:'徵调 · 中阮', instrument:'中阮', rarity:'SSR', rarityName:'天籁', role:'温弦归梦', description:'中阮音色温润圆厚，节奏与和声表现稳定，常在乐队中托起柔和而坚实的声部。', image:'assets/cards/zhi_zhongruan.png', mobileImage:'assets/cards/zhi_zhongruan.png', toneName:'徵音', element:'火', fullAudio:'assets/audio/zhi_zhongruan.mp3', pieceAudio:'assets/audio/zhi_zhongruan.mp3', audioSegmentSeconds:10 },
  { id:'yu_hulusi', tone:'yu', name:'羽调 · 葫芦丝', instrument:'葫芦丝', rarity:'SSR', rarityName:'天籁', role:'水乡柔梦', description:'葫芦丝音色柔和甜润，带有浓郁民族色彩，如水边微风与温柔歌声。', image:'assets/cards/yu_hulusi.png', mobileImage:'assets/cards/yu_hulusi.png', toneName:'羽音', element:'水', fullAudio:'assets/audio/yu_hulusi.mp3', pieceAudio:'assets/audio/yu_hulusi.mp3', audioSegmentSeconds:10 },
  ...
  { id:'yu_suona', tone:'yu', name:'羽调 · 唢呐', instrument:'唢呐', rarity:'SSR', rarityName:'天籁', role:'长天破晓', description:'唢呐音色高亢嘹亮，极具穿透力，既能热烈欢腾，也能唱出苍凉与激越。', image:'assets/cards/yu_suona.png', mobileImage:'assets/cards/yu_suona.png', toneName:'羽音', element:'水', fullAudio:'assets/audio/yu_suona.mp3', pieceAudio:'assets/audio/yu_suona.mp3', audioSegmentSeconds:10 },
];
const PIECE_COUNT = 9;
